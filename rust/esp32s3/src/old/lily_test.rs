...
async fn main(_spawner: Spawner) {
    ...
    let lora_busy = esp_hal::gpio::Input::new(peripherals.GPIO4, esp_hal::gpio::Pull::None);
    let lora_dio1 = esp_hal::gpio::Input::new(peripherals.GPIO1, esp_hal::gpio::Pull::None);
    ...
    let buffer = [0x04u8, 0x05u8, 0x06u8];
